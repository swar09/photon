...
//     // Use diffrent approach this is not okay , its fast very complex thing ! !! !
//     // Just forst implement the HNSW or implement with care so you can  understand properly
//     // That not a clean and neat apraoch there exists better appraoches !
// }
